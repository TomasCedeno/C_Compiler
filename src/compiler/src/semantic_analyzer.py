...
if args.no_output:
	...
	args.sem_no_output=False

hooks=Hooks()
hooks.add_entry("lex","ANALIZADOR LÉXICO",lex)
hooks.add_entry("syn","ANALIZADOR SINTÁTICO",syn),
hooks.add_entry("sem","ANALIZADOR SEMÁNTICO",sem)
